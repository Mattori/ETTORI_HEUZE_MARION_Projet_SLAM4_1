...
return array(
  ...
  'models\\Site::$latitude' => array(
    array('#name' => 'column', '#type' => 'Ubiquity\\annotations\\ColumnAnnotation', "name"=>"latitude","nullable"=>1,"dbType"=>"double")
  ),
  'models\\Site::$longitude' => array(
    array('#name' => 'column', '#type' => 'Ubiquity\\annotations\\ColumnAnnotation', "name"=>"longitude","nullable"=>1,"dbType"=>"double")
  ),
  'models\\Site::$ecart' => array(
    array('#name' => 'column', '#type' => 'Ubiquity\\annotations\\ColumnAnnotation', "name"=>"ecart","nullable"=>1,"dbType"=>"double")
  ),
  ...
  'models\\Site::$lienwebs' => array(
    array('#name' => 'oneToMany', '#type' => 'Ubiquity\\annotations\\OneToManyAnnotation', "mappedBy"=>"site","className"=>"models\\Lienweb")
  ),
  'models\\Site::$reseaus' => array(
    array('#name' => 'oneToMany', '#type' => 'Ubiquity\\annotations\\OneToManyAnnotation', "mappedBy"=>"site","className"=>"models\\Reseau")
  ),
  'models\\Site::$utilisateurs' => array(
    array('#name' => 'oneToMany', '#type' => 'Ubiquity\\annotations\\OneToManyAnnotation', "mappedBy"=>"site","className"=>"models\\Utilisateur")
  ),
);
