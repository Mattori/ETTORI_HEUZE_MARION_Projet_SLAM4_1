...
return array(
  ...
  'models\\Utilisateur::$nom' => array(
    array('#name' => 'column', '#type' => 'micro\\annotations\\ColumnAnnotation', "name"=>"nom","nullable"=>1,"dbType"=>"varchar(25)")
  ),
  'models\\Utilisateur::$prenom' => array(
    array('#name' => 'column', '#type' => 'micro\\annotations\\ColumnAnnotation', "name"=>"prenom","nullable"=>1,"dbType"=>"varchar(25)")
  ),
